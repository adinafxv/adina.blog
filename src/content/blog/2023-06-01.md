...
title: Testing page + todo
postSlug: update-blog
featured: true
draft: false
tags:
  - branding
ogImage: ""
description: This is a todo for future works on this blog.
---

This blog running on Astro Paper does need a little bit of work to match my brand and use-case. I really love the fact that it takes MD files as input. There are things I do need to fix tho. Let‘s get to it.

## Intro

Everything is stored in this [github repo - adina.blog](https://github.com/adinafxv/adina.blog), and deployed by Vercel directly to [adina.blog](https://adina.blog).
...
<section class="note drawn arrow-whoosh">
this is a little note in handdrawn style
</section>

<section class="note tech">
this is a little note in tech style
</section>

Here a little paragraph, just to make sure this works

Here you go.

<section class="note drawn arrow">
this is a little note in handdrawn style
</section>
